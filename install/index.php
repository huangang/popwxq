...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用POPteam微信公共平台 ，还是部份栏目使用POPteam微信公共平台，在你使用了POPteam微信公共平台 的网站主页上必须加上POPteam微信公共平台   官方网址(<a href="http://w.zd3.cn" target="_blank">w.zd3.cn</a>)的链接。</p>
				<p>4、未经官方许可，禁止在POPteam微信公共平台的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装POPteam微信公共平台，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
