...
<div class="system-message">
	...
	<div style="padding:24px;">
		<?php if(isset($message)): ?><div class="success"><img style="margin-right: 9px;" src="../../ThinkPHP/success.png"><span><?php echo($message); ?></span></div>
		<?php else: ?>		
		<div class="error"><img style="margin-right: 9px; cursor:pointer;" src="../../ThinkPHP/error.png"/><span><?php echo($error); ?></span></div><?php endif; ?>
